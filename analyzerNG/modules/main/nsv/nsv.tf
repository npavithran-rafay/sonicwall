...
module "nsm-analyzerng_ec2_nsv_az_one" {
  ...
  sd_check               = "true"
  name_tag               = "${var.prefix_analyzer}-analyzerng-nsv"
  ...
  #ami_private_subnet_id  = data.terraform_remote_state.vpc-output.outputs.emr_bucketid[15]
  #ami_private_subnet_id  = var.subnet_ids
