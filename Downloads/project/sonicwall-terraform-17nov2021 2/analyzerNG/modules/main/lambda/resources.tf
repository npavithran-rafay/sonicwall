...
module "lambda" {
  ...
  environment = {
     ATHENA_DATABASE        = data.terraform_remote_state.athena.outputs.Athena_database
     ATHENA_OUTPUT_LOCATION = "s3://${data.terraform_remote_state.athena.outputs.S3bucketname}/athena-query-results/"
     REDSHIFT_ENDPOINT      = data.terraform_remote_state.redshift.outputs.redshift_cluster_endpoint
     REDSHIFT_DATABASE      = data.terraform_remote_state.redshift.outputs.redshift_cluster_database_name
     REDSHIFT_PASSWD        = data.terraform_remote_state.redshift.outputs.redshift_password
     REDSHIFT_PORT          = data.terraform_remote_state.redshift.outputs.redshift_cluster_port
     REDSHIFT_USER          = data.terraform_remote_state.redshift.outputs.redshift_username
  }
  tags = {
...
module "lambda_schedulejobs" {
  source             = "../../../../modules/infrastructure/lambda_tf13"
  function_name      = "${var.prefix}-analyzerng-schedulejobs-lambda"
  description        = var.description
  handler            = var.handler
  runtime            = var.runtime
  memory_size        = var.memory_size
  ...
  tags = {
    Name            = "${var.prefix}-analyzerng-schedulejobs-lambda"
    Application     = var.application
    Environment     = var.tag_environment
    BU              = var.bu
    Region          = var.tag_region
...
module "lambda_logparser" {
  source             = "../../../../modules/infrastructure/lambda_tf13"
  function_name      = "${var.prefix}-analyzerng-logparser-lambda"
  ...
  environment = {
     bucket_name         = data.terraform_remote_state.s3.outputs.bucketname_jar
     config_filename     = "config/config.json"
     lambda_name         = "${var.prefix}-analyzerng-logparser-lambda"
     region              = var.region
     restart_lambda_name = "${var.prefix}-analyzerng-event-delete-dynamodb-tables-lambda"
  }
  tags = {
    Name            = "${var.prefix}-analyzerng-logparser-lambda"
    Application     = var.application
    Environment     = var.tag_environment
    BU              = var.bu
    Region          = var.tag_region
...
module "lambda_logprocessor" {
  source             = "../../../../modules/infrastructure/lambda_tf13"
  function_name      = "${var.prefix}-analyzerng-logprocessor-lambda"
  ...
  environment = {
     bucket_name         = data.terraform_remote_state.s3.outputs.bucketname_jar
     config_filename     = "config/config.json"
     lambda_name         = "${var.prefix}-analyzerng-logprocessor-lambda"
     region              = var.region
     restart_lambda_name = "${var.prefix}-analyzerng-event-delete-dynamodb-tables-lambda"
  }
  tags = {
    Name            = "${var.prefix}-analyzerng-logprocessor-lambda"
    Application     = var.application
    Environment     = var.tag_environment
    BU              = var.bu
    Region          = var.tag_region
...
module "lambda_realtimereport" {
  source             = "../../../../modules/infrastructure/lambda_tf13"
  function_name      = "${var.prefix}-analyzerng-realtimereport-lambda"
  ...
  tags = {
    Name            = "${var.prefix}-analyzerng-realtimereport-lambda"
    Application     = var.application
    Environment     = var.tag_environment
    BU              = var.bu
    Region          = var.tag_region
...
module "lambda_bucketmonitor" {
  source             = "../../../../modules/infrastructure/lambda_tf13"
  function_name      = "${var.prefix}-analyzerng-s3bucketmonitor-lambda"
  ...
  environment = {
     ...
     lambda_name         = "${var.prefix}-analyzerng-s3bucketmonitor-lambda"
     region              = var.region
  }
  tags = {
    Name            = "${var.prefix}-analyzerng-s3bucketmonitor-lambda"
    Application     = var.application
    Environment     = var.tag_environment
    BU              = var.bu
    Region          = var.tag_region
...
module "lambda_terminaterestartemr" {
  source             = "../../../../modules/infrastructure/lambda_tf13"
  function_name      = "${var.prefix}-analyzerng-terminaterestartemr-lambda"
  ...
  tags = {
    Name            = "${var.prefix}-analyzerng-terminaterestartemr-lambda"
    Application     = var.application
    Environment     = var.tag_environment
    BU              = var.bu
    Region          = var.tag_region
...
module "lambda_deleteDynamodbemr" {
  source             = "../../../../modules/infrastructure/lambda_tf13"
  function_name      = "${var.prefix}-analyzerng-event-delete-dynamodb-tables-lambda"
  ...
  environment = {
     ...
     lambda_execute_name               = "${var.prefix}-analyzerng-terminateEMR-deleteDynamodbTables-lambda"
     lambda_name                       = "${var.prefix}-analyzerng-event-delete-dynamodb-tables-lambda"
     region                            = var.region
  }
  tags = {
    Name            = "${var.prefix}-analyzerng-event-delete-dynamodb-tables-lambda"
    Application     = var.application
    Environment     = var.tag_environment
    BU              = var.bu
    Region          = var.tag_region
...
module "lambda_terminatemrdynamodb" {
  source             = "../../../../modules/infrastructure/lambda_tf13"
  function_name      = "${var.prefix}-analyzerng-terminateEMR-deleteDynamodbTables-lambda"
  ...
  tags = {
    Name            = "${var.prefix}-analyzerng-terminateEMR-deleteDynamodbTables-lambda"
    Application     = var.application
    Environment     = var.tag_environment
    BU              = var.bu
    Region          = var.tag_region
...
module "lambda_stepFunctionemr" {
  source             = "../../../../modules/infrastructure/lambda_tf13"
  function_name      = "${var.prefix}-analyzerng-eventBridge-stepFunction-cease-lambda"
  ...
  role_arn           = aws_iam_role.iam_for_lambda.arn
  environment = {
     arn                               = "arn:aws:lambda:${var.region}:${data.aws_caller_identity.current.account_id}:function:${var.prefix}-analyzerng-eventBridge-stepFunction-cease-lambda"
     lambda_name                       = "${var.prefix}-analyzerng-eventBridge-stepFunction-cease-lambda"
...
#     subject                           = "'URGENT: EMR Crashed Multiple Times'"
  ...
  tags = {
    Name            = "${var.prefix}-analyzerng-eventBridge-stepFunction-cease-lambda"
    Application     = var.application
    Environment     = var.tag_environment
    BU              = var.bu
    Region          = var.tag_region
  ...
  input = <<EOF
{
    ...
    "lambda_function_name":"${var.prefix}-analyzerng-logparser-lambda"
}
EOF
}
  ...
  input = <<EOF
{
    ...
    "lambda_function_name":"${var.prefix}-analyzerng-logprocessor-lambda"
}
EOF
}
