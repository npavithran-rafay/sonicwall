...
output "eks_neo4j_new_subnet_ids" {
  value = "${aws_subnet.eks_neo4j_new_private_subnets.*.id}"
}
output "eks_gitea_new_subnet_ids" {
  value = "${aws_subnet.eks_gitea_new_private_subnets.*.id}"
}
